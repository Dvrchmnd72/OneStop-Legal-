...
/**
 * OneStop SEO: fallback meta description for conveyancing quote page.
 */
add_action('wp_head', function () {
    if (!is_page('conveyancing-quote')) {
        return;
    }

    echo '<meta name="description" content="Get an instant fixed-fee conveyancing quote from OneStop Legal. Transparent pricing for buying or selling property in Queensland, with solicitor-led support and no hidden costs." />' . "\n";
}, 2);
