...
.suburb-back { max-width: 900px; margin: 0 auto; padding: 20px 20px 0; display: flex; flex-wrap: wrap; gap: 12px 18px; align-items: center; }
.suburb-back a { color: #C8A961; text-decoration: none; font-size: 14px; }
.suburb-back a:hover { text-decoration: underline; }
.suburb-back .suburb-quote-link { font-weight: 700; }
</style>

<div class="suburb-back">
  <a href="/conveyancing/">&larr; Back to Conveyancing</a>
  <a href="/conveyancing/gold-coast/">Gold Coast conveyancing suburbs</a>
  <a href="/conveyancing-quote/" class="suburb-quote-link">Get a fixed-fee conveyancing quote</a>
</div>
